...
function StyleWiseEmbStatusReport() {
  ...
  useEffect(() => {
    document.title = "Style Wise Embellishment Status Report";
  }, []);
  ...
  return isLoading ? (
    ...
    <div>
      <Report
        isEmbDone={isEmbDone}
        isEmbNotDone={isEmbNotDone}
        styleData={filteredStyleData}
        embData={filteredEmbData}
        searchParams={{ fromDate: fromShipDate || "", toDate: toShipDate || "", isShipDate: isShipDate }}
      />
    </div>
  );
}

export default StyleWiseEmbStatusReport;
