...
function DateColorWiseShiplentSummaryReport() {

  const [data, setData] = useState<DateColorWiseShiplentSummaryReportType[]>([]);
  ...
  useEffect(() => {
    document.title = "Date & Color Wise Shipment Summary Report";
  }, []);
  ...
  return isLoading ? (
    ...
    <>
      <div className="w-fit ms-auto me-auto min-w-[60%]">
        <Report data={data} searchParams={{ toDate, fromDate }}></Report>
      </div>
    </>
  );
}
export default DateColorWiseShiplentSummaryReport;
