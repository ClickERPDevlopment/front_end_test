...
function ReportTable({
  ...
  if (data) {
    groupedByDate = groupBy(data, ["STYLENAME", "MTL_COLOR_NAME", "GMT_SIZE_NAME", "UOM", "SUPPLIER_RATE_PER_PCS"]);
  }
  ...
  return (
    <>
      <tr style={{ fontSize: "11px" }} className="font-bold">
        <td colSpan={7} className="border border-gray-950 p-0.5">PO: {data[0]?.PO_NO} | MTL NAME: {data[0]?.MTL_NAME}</td>
      </tr>
