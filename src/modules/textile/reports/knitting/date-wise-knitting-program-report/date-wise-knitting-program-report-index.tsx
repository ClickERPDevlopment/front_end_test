...
function DateWiseKnittingProgramReport() {
  const [data, setData] = useState<DateWiseKnittingProgramReportType[]>([]);
    ...
    async function getData() {
      ...
      try {
        const response = await axios.get(
          `${api.ProductionUrl}/production/KnittingReport/DateWiseKnittingProgramReport`,
          {
            params: {
              id,
              factoryId,
...
export default DateWiseKnittingProgramReport;
