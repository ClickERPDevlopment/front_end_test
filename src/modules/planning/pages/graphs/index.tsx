...
import { tnaChartComponentKeys, DashboardConfig, DashboardItem } from "../../../../types/global";
import Button from "../../../../components/form/Button";
import FeatherIcon from "../../../../components/FeatherIcon";
import { PlusCircle } from "react-feather";
import { fetchTNADasboardConfig, updateTNADashboardConfig } from "../../reduxSlices/tnaDashboardSlice";

const GraphDashboard = () => {

    const dispatch: AppDispatch = useDispatch();
    const dashboardConfig = useSelector((state: RootState) => state.tnaDashboard.config);
    ...
    useEffect(() => {
        ...
        dispatch(fetchTNADasboardConfig())
    ...
    const handleLayoutChange = (layout: Layout[]) => {
        ...
        dispatch(updateTNADashboardConfig({ ...configToUse, items: updatedItems }));
    };
    ...
    const handleOnResizeStop = (layout: Layout[], newItem: Layout) => {
        ...
        dispatch(updateTNADashboardConfig(updatedConfig));
    };
    ...
    const deleteDashboardItem = async (itemId: number) => {
        ...
        dispatch(updateTNADashboardConfig(updatedDashboard));
    };
