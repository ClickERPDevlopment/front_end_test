...
import {  DashboardConfig, DashboardItem, productionChartComponentKeys } from "../../../../types/global";
import Button from "../../../../components/form/Button";
import FeatherIcon from "../../../../components/FeatherIcon";
import { PlusCircle } from "react-feather";
import {  fetchProductionDasboardConfig, updateProductionDashboardConfig,  } from "../../reduxSlices/productionDashboardSlice";

const ProductionGraphDashboard = () => {

  const dispatch: AppDispatch = useDispatch();
  const dashboardConfig = useSelector((state: RootState) => state.productionDashboard.config);
  ...
  useEffect(() => {
    document.title = "Production Dashboard";
    dispatch(fetchProductionDasboardConfig())
  ...
  const handleLayoutChange = (layout: Layout[]) => {
    ...
    dispatch(updateProductionDashboardConfig({ ...configToUse, items: updatedItems }));
  };
  ...
  const handleOnResizeStop = (layout: Layout[], newItem: Layout) => {
    ...
    dispatch(updateProductionDashboardConfig(updatedConfig));
  };
  ...
  const deleteDashboardItem = async (itemId: number) => {
    ...
    dispatch(updateProductionDashboardConfig(updatedDashboard));
  };
    ...
    <div className="p-0  bg-gray-100 dark:bg-gray-800">
      ...
      >
        <div className="grid grid-cols-1 gap-4">
          ...
          <div>
            <SelectDropdown
              options={productionChartComponentKeys}
              value={widget}
              isSameKeyValue={true}
...
export default ProductionGraphDashboard;
