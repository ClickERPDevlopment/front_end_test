...
const SewingInputOutputReportForm = () => {
    ...
    const handleShowReport = () => {
        ...
        const params = new URLSearchParams({
            ...
            styleId: searchData.styleId.toString(),
            buyerId: searchData.buyerId.toString(),
            colorId: searchData.colorId.toString(),
            po: searchData.po.toString(),
            fromDate: searchData.fromDate,
            toDate: searchData.toDate,
            fromOPMDate: searchData.fromOPMDate,
            toOPMDate: searchData.toOPMDate,
        });

        const url = `${webRoutes.SEWING_INPUT_OUTPUT_REPORT}?${params.toString()}`;
    ...
    return (
        <Panel className="min-h-screen p-4 sm:p-6 overflow-auto" rounded={false}>
            <div className="mt-5 space-y-2">
                    ...
                    >
                        <DropdownAutoSuggest
                            ...
                            onSelect={(val, displayVal) =>
                                handleChangeSearchInfo("factoryId", val)
                            }
                        />
                    </FormField>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2">
                    ...
                    >
                        <DropdownAutoSuggest
                            name="styleList"
                            onSelect={(val, displayVal) =>
                                handleChangeSearchInfo("styleId", val)
                            }
                        />
                    </FormField>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2">
                    <FormField label="PO" id="po" variant="inline" labelFontSize="text-sm">
                        <DropdownAutoSuggest
                            name="purchaseOrderList"
                            onSelect={(val, displayVal) => {
                                handleChangeSearchInfo("poId", val);
                                handleChangeSearchInfo("po", displayVal);
                            }}
                        />
                    </FormField>
                </div>
...
export default SewingInputOutputReportForm;
