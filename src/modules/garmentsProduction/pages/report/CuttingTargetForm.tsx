...
const CuttingTargetReportForm = () => {
    ...
    const handleShowReport = () => {
        ...
        if (isDateRange) {
            url = `${webRoutes.CUTTING_TARGET_DATE_RANGE_REPORT}?factory_id=${formData.factoryId
            ...
            url = `${webRoutes.CUTTING_TARGET_REPORT}?factory_id=${formData.factoryId
...
export default CuttingTargetReportForm;
