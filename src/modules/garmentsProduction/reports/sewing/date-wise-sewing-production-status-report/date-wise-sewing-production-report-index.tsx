...
function DateWiseSewingProductionReport() {
  const [data, setData] = useState<DateWiseSewingProductionReportDto[]>([]);
    ...
    async function getData() {
      ...
      try {
        const response = await axios.get(
          `${api.ProductionUrl}/production/GmtSewingReport/DateWiseSewingProductionReport`,
          {
            params: {
              fromDate,
              toDate,
...
export default DateWiseSewingProductionReport;
